...
<?php
                ...
                $q = "SELECT * FROM `flats` ORDER BY `flat_id`  LIMIT  {$offset},{$limit}";
                $flat_data=array();
...
if (isset($_POST['check'])) {
  ...
  $q="SELECT * FROM `flats` WHERE `location`='$location' AND `rooms`='$rooms' OR `price` < '$price'";
...
<label for="Flat name">Price:</label>
  ...
  <option class="form-control" value="20000000">less than 20000000</option>
  <option class="form-control" value="50000000">less than 50000000</option>
  <option class="form-control" value="100000000">less than 100000000</option>
  <option class="form-control" value="500000000">less than 500000000</option>
</select>
</div>
<div class="child">
<label for="Flat name">Rooms:</label>
...
<button class="btn btn-primary" type="submit" name="check">Show Results</button>
      ...
      <?php
                    ...
                    ?>
    <div style="margin-top:20px;background:#FFFF99" class="property-box">
        ...
        <div class="property-box__right">
            ...
            <div class="property-box__post-price">
                ...
                <span class="badge" style="background-color:black;">Rs.<?php echo $convertedPrice ?></span>
                </div>
            </div>
        </div>
    </div>
...
<p style="text-align:center">
        ...
        for ($i = 1; $i <= $totalpage; $i++) {
          ...
          echo '  <a href="flat1.php?page='.$i.'" class="btn btn-info ">'.$i.'</a>';
        }
        ?>
      </p> 
