...
if (isset($_POST['save'])) {
  ...
  $q = " INSERT INTO `flats`(`name`, `builders_name`, `price`, `rooms`, `ammenities`, `address`,`location`, `contact_builder`, `flat_image`,`more_image`) VALUES ('$name','$builders_name','$price','$rooms','$ammenities','$address','$location','$contact_builder','$folder','$data')";
...
<div class="container" style="height:1200px">
    <form action="#" method='post' name="form" onsubmit="return validateForm();" autocomplete="off" enctype="multipart/form-data" class="form">
      <h2 class="title" style="text-align:center;">ADD FLAT</h2>
