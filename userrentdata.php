...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="#">User Rents<span class="sr-only">(current)</span></a>
    </div>
  </div>
</nav>
        <section class="table__body">
            <table>
                <thead>
                    ...
                    <th><i>Original Documents Image</i></th>
                    <!-- <th colspan="2"><i><button class="btn btn-primary  float-right"><a href="newrent.php" class="text-white">(+)Add new Villa </i></a></button></i></th> -->
                    </tr>
                </thead>
                <?php
        $limit = 5;
        ...
        $q = "SELECT * FROM `userrents` ORDER BY `rent_id`  LIMIT  {$offset},{$limit}";
        ...
        ?>
            ...
            ?>
              ...
              <td ><?php echo $res['original_docs'] ?></td>
              <td><button class="btn btn-danger btn " name="delete"><a style="color:black" href="deleteuserdata.php?id=<?php echo $res['rent_id']; ?>"><i class="fa fa-trash-o"></a></i></button></td>
    ...
    <div class="modal-content">
      <img id="modalImage" src="" alt="Modal Image">
        ...
        for ($i = 1; $i <= $totalpage; $i++) {
          ...
          echo '  <a href="userrentdata.php?page='.$i.'" class="btn btn-success ">'.$i.'</a>';
        }
        ?>
      </p>
      <script>
