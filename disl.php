...
<?php
$id = $_GET['land_id'];
$q = "SELECT * FROM `land` where land_id=$id";
		...
		<div class="about-main">
			...
			<div class="row">
				<div class="flip-card">
				  <div class="flip-card-inner">
					<div class="flip-card-front">
					  <img src="website/images/gym.png" alt="" style="width:150px;height:150px;">
					</div>
				...
				<div class="flip-card">
					<div class="flip-card-inner">
					  <div class="flip-card-front">
						<img src="website/images/hotel.png" alt="" style="width:150px;height:150px;">
					  </div>
					  <div class="flip-card-back">
						<p>HOTEL</p> 
					  </div>
				  ...
				  <div class="flip-card">
					<div class="flip-card-inner">
					  <div class="flip-card-front">
						<img src="website/images/bus.png" alt="" style="width:150px;height:150px;">
					  </div>
					  <div class="flip-card-back">
						<p>BUS STAND</p> 
					  </div>
				  ...
				  <div class="flip-card">
					<div class="flip-card-inner">
					  <div class="flip-card-front">
						<img src="website/images/pool.png" alt="" style="width:150px;height:150px;">
					  </div>
					  <div class="flip-card-back">
						<p>POOL</p> 
					  </div>
				  ...
				  <div class="flip-card">
					<div class="flip-card-inner">
					  <div class="flip-card-front">
						<img src="website/images/market.png" alt="" style="width:150px;height:150px;">
					  </div>
					  <div class="flip-card-back">
						<p>MARKET</p> 
					  </div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
      <img id="modalImage" src="" alt="Modal Image">
				...
				<hr style="margin-left:0px;height:6px;border-width:0;color:gray;background-color:black;margin-right:300px">
				<ul>
                <li class="red" style="font-size: 20px; font-weight: 1000;">AREA in sqfts </li>
					<p style="font-size:40px;"> <?php echo $area."sqfts"?></p>  
					...
					<li class="red" style="font-size: 20px; font-weight: 1000;">OWNER'S NAME</li>
					<p style="font-size:40px;"> <?php echo $owner ?></p>
					<?php 
                              $price = $price;
					...
					<li class="red" style="font-size: 20px; font-weight: 1000;">Geography</li>
					<p style="font-size:40px;"> <?php echo $geography ?></p>
                    <li class="red" style="font-size: 20px; font-weight: 1000;">TYPE OF LAND</li>
					<p style="font-size:40px;"> <?php echo $type ?></p>
                    <li class="red" style="font-size: 20px; font-weight: 1000;">TYPE OF SOIL</li>
					<p style="font-size:40px;"> <?php echo $soil ?></p>
					<li class="red" style="font-size: 20px; font-weight: 1000;">AMMENITIES</li>
					<p style="font-size:40px;"> <h2 style="color:black"><?php echo $ammenities ?></h2></p>
