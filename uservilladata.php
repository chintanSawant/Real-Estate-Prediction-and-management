...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="#">User Villas<span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="userrentdata.php">User Rents</a>
        ...
        $q = "SELECT * FROM `uservilla` ORDER BY `villa_id`  LIMIT  {$offset},{$limit}";
        ...
        ?>
            ...
            {
              ?>  
                <img src="villa_images/<?= $img[$i]?>" height="100px" width="100px" onclick="openModal(this)"/>ea
               <?php
            }
            ?>
              </td>
              <td ><?php echo $res['original_docs'] ?></td>
              <td><button class="btn btn-danger" name="delete"><a style="color:black" href="deleteuservilla.php?id=<?php echo $res['villa_id']; ?>"><i class="fa fa-trash-o"></a></i></button></td>
    ...
    <div class="modal-content">
      <img id="modalImage" src="" alt="Modal Image">
        ...
        for ($i = 1; $i <= $totalpage; $i++) {
          ...
          echo '  <a href="uservilladata.php?page='.$i.'" class="btn btn-success ">'.$i.'</a>';
        }
        ?>
      </p>  
      <script>
