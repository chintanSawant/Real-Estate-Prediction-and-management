...
while ($row = mysqli_fetch_assoc($res)) {
	$name = $row['name'];
    $builders_name = $row['builders_name'];
    $price = $row['price'];
    $rooms = $row['rooms'];
    $ammenities = $row['ammenities'];
    $address = $row['address'];
    $location=$row['location'];
    $contact_builder = $row['contact_builder'];
		...
		<style>
		 ...
		 <?php
			...
			<div class="photo">
                ...
                <img src="admin/flat_images/<?= $img[$i]?>" onclick="openModal(this)"/>
    ...
    <div class="modal-content">
      <img id="modalImage" src="" alt="Modal Image">
				...
				<ul>
					...
					<li class="red" style="font-size: 20px; font-weight: 1000;">BUILDER NAME</li>
					<p style="font-size:40px;"> <?php echo $builders_name ?></p>
					<?php 
					...
					<li class="red" style="font-size: 20px; font-weight: 1000;">CONTACT BUILDER</li>
					<a href="tel:<?php echo $contact_builder ?>" style="font-size:40px;color:black" title="Call"><i class="fa fa-phone"> </i> <?php echo  $contact_builder ?></a>
